...
async function openAsset(assetId) {
  ...
  try {
    ...
    image.addEventListener("error", () => { loading.className = "preview-fallback"; loading.innerHTML = "Prepared preview is still processing or unavailable.<br>The asset record and immutable media remain preserved."; image.remove(); });
